...
const TopHeader = () => {
    return (
        <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white border-b">
        <nav class="relative w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div class="flex items-center justify-between">
            <Link class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80" href="/" aria-label="Brand">Resource Share</Link>
          ...
          <div id="hs-base-header" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block" aria-labelledby="hs-base-header-collapse">
            <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
              <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">  <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                <Link class="p-2 flex items-center text-sm text-black focus:outline-none focus:text-black" href="/" aria-current="page">
                ...
                <Link class="p-2 flex items-center text-sm text-black/80 hover:text-black focus:outline-none focus:text-black" href="/student/upload">
                ...
                <Link class="p-2 flex items-center text-sm text-black/80 hover:text-black focus:outline-none focus:text-black" href="/tandCs">
                ...
                <div class="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 mt-1 md:mt-0 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-black/30 before:-translate-y-1/2">
                  <Link href="/auth/sign-in" class="p-2 w-full flex items-center text-sm text-black/80 hover:text-black focus:outline-none focus:text-black">
                ...
                <Link href="/student" class="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 mt-1 md:mt-0 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-black/30 before:-translate-y-1/2">
                  <Avatar>
                    <AvatarFallback>FM</AvatarFallback>
                    </Avatar>
                </Link>
                {/* <div class="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 mt-1 md:mt-0 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-black/30 before:-translate-y-1/2">
                  <Link href="/auth/sign-up" class="p-2 w-full bg-black rounded-md  text-sm flex items-center text-sm text-white hover:white focus:outline-none focus:text-white">
                    Register
                  </Link>
                </div> */}
              </div>
